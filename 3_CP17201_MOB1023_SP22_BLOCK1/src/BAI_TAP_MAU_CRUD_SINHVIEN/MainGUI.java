...
public class MainGUI extends javax.swing.JFrame {
  ...
  private void btn_fakeDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_fakeDataActionPerformed
    ...
    int stt = 1;
    _iSinhVienService.fake5SV();//Đổ dữ liệu vào List ở bên Service
    for (SinhVien x : _iSinhVienService.getlstSinhVien()) {
      _dDefaultTableModel.addRow(new Object[]{stt++,x.getId(),x.getTen(),x.getSdt(),x.getMsv(),x.getNganhHoc(),x.getGioiTinh()});
    }
