...
public class MainGUI extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    btn_luu.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
    btn_luu.setText("Lưu File");
    ...
    btn_Doc.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
  ...
  private void btn_luuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_luuActionPerformed
    JOptionPane.showMessageDialog(this, _iSinhVienService.ghiFile(duongDan));
    loadTable(_iSinhVienService.getlstSinhVien());
  }//GEN-LAST:event_btn_luuActionPerformed

  private void btn_DocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DocActionPerformed
    JOptionPane.showMessageDialog(this, _iSinhVienService.docFile(duongDan));
    loadTable(_iSinhVienService.getlstSinhVien());
